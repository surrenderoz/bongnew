                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Label Manager</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">add Label</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <form method="post" @submit.prevent="pushData">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group fill">
                                        <label class="floating-label" for="">Manager</label>
                                        <input type="text" class="form-control" id="" v-model="setData.manager" required>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group fill">
                                        <label class="floating-label" for="">Email ID</label>
                                        <input type="email" class="form-control" id="" v-model="setData.email" required>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group fill">
                                        <label class="floating-label" for="">Phone </label>
                                        <input type="number" class="form-control" id="" v-model="setData.telephone" required>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group fill">
                                        <label class="floating-label" for="">Country</label>
                                        <input type="text" class="form-control" id="" v-model="setData.country" required>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group fill">
                                        <label class="floating-label" for="">City</label>
                                        <input type="text" class="form-control" id="" v-model="setData.city" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group fill">
                                        <label class="floating-label" for="">Address</label>
                                        <textarea type="text" class="form-control" id="" v-model="setData.address" required></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group fill">
                                        <label class="floating-label" for="">Description</label>
                                        <textarea type="text" class="form-control" id="" v-model="setData.description" required></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group fill">
...
export default {
  ...
  methods: {
    ...
    pushData () {
      ...
      formData.append('manager', this.setData.manager)
      formData.append('telephone', this.setData.telephone)
      formData.append('emailId', this.setData.email)
      formData.append('city', this.setData.city)
      formData.append('country', this.setData.country)
      formData.append('address', this.setData.address)
      getApi.post('/label',
        formData,
        {
          headers: {
